<?php
ob_start();
include 'backend/config.php'; // sesuaikan path jika perlu
    ...
    <div class="pro-container">
        <?php while($product = $result->fetch_assoc()): ?>
            <div class="pro">
                ...
                <div class="des">
                    <span><?= htmlspecialchars($product['seller_id']) ?></span>
                ...
                <a href="detail.php?id=<?= $product['id'] ?>" class="cart-btn">
...
<section id="sm-banner" class="section-p1">
    <div class="banner-box">
        ...
        <a href="shop.php" class="white">Learn More</a>
    </div>
    <div class="banner-box banner-box2">
        <h4>spring/summer</h4>
        <h2>upcoming season</h2>
        <span>The best classic dress is on sale at cara</span>
        <a href="shop.php" class="white">Collection</a>
    </div>
</section>
