...
<div class="navbar">
    ...
    <div class="menu">
        ...
        <a class="active" href="dikemas.php"><i class="fas fa-box"></i> Dikemas</a>
            ...
            <div class="order-section">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td><img src="<?= htmlspecialchars($img) ?>" alt="<?= htmlspecialchars($row['name']) ?>" style="width:60px;height:60px;"></td>
