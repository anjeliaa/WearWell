...
<div class="container">
    ...
    <h3 style="text-align:center;">Keranjang Kamu</h3>
    ...
    <?php if(count($cart_items) > 0): ?>
        <table class="cart-table">
            ...
            <tr>
                ...
                <td><input type="number" name="quantity" value="<?= htmlspecialchars($qty) ?>" min="1" style="width:60px;"></td>
                <td>Rp <?= number_format($price,0,',','.') ?></td>
                <td>Rp <?= number_format($price * $qty,0,',','.') ?></td>
                <td>
                        <button type="submit" class="btn btn-update">Update</button>
                    </form>
                    <form action="delete_cart.php" method="POST" class="cart-delete-form" style="margin-top:6px;">
                        <input type="hidden" name="cart_id" value="<?= htmlspecialchars($cart_id) ?>">
        ...
        <div style="text-align:right; margin-top:15px;">
            <button class="btn-checkout" onclick="toggleCheckout()">Proceed to Checkout</button>
        </div>
    ...
    <?php else: ?>
        <p style="text-align:center;">Keranjang kamu kosong. <a href="shop_user.php">Belanja Sekarang</a></p>
    <?php endif; ?>
</div>
