...
// Ambil semua order dengan status Shipped
$stmt = $conn->prepare("
    SELECT * FROM orders 
    WHERE id_users = ? AND status = 'Shipped' 
...
<title>Pesanan Dikirim | WearWell</title>
...
<div class="navbar">
    ...
    <div class="menu">
        ...
        <a href="dikemas.php" class="nav-item">
            <i class="fas fa-box"></i>
            <span>Dikemas</span>
        </a>
        <a href="dikirim.php" class="nav-item active">
...
<div class="container">
    ...
    <?php if(count($orders) > 0): ?>
        ...
        <?php endforeach; ?>
    <?php else: ?>
        <p>Tidak ada pesanan yang dikirim saat ini.</p>
    <?php endif; ?>
